...
show-paren, viper."
  ...
  (color-theme-install
   '(color-theme-rotor
    ...
    (tabbar-button-face ((t (:background "wheat" :foreground "DarkOliveGreen"))))
    (tabbar-default-face ((t (:background "wheat" :foreground "DarkOliveGreen"))))
    (tabbar-selected-face ((t (:background "khaki" :foreground "DarkOliveGreen"))))
